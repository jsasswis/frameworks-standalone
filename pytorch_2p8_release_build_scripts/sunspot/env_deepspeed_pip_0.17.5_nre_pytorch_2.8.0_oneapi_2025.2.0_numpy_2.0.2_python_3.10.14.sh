...
CONDA_ENV_NAME=deepspeed_pip_0.17.5_nre_pytorch_2.8.0_oneapi_2025.2.0_numpy_2.0.2_python3p10p14
...
echo ""
echo "Finished installing the deepspeed/0.17.5 and dependencies"
echo ""
